    ...
    >
      ...
      <div className="relative z-10 flex items-center justify-center">
        <div className="relative h-32 w-32 md:h-44 md:w-44 rounded-full flex items-center justify-center text-white font-bold text-center p-4">
          <div className="absolute w-20 h-20 md:w-full md:h-full bg-black/70 blur-md rounded-full" />
          <span className="z-20 text-white font-extrabold uppercase tracking-widest font-mono text:md lg:text-2xl  transition duration-500">
            {text}
          </span>
        </div>
      </div>
